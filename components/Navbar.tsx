    ...
    <nav className="absolute left-0 top-0 z-[99999] w-full border-b border-white/10 bg-black/20 backdrop-blur-sm">
      <div className="mx-auto flex max-w-[1180px] items-center justify-between px-4 py-3 md:px-8 md:py-4">
        ...
        <details className="relative lg:hidden">
          <summary className="cursor-pointer list-none rounded border border-[#69ff2f] px-4 py-2 text-[12px] font-black uppercase text-white">
            Menu
          </summary>

          <div className="absolute right-0 top-[52px] z-[100000] w-[250px] rounded-xl border border-[#69ff2f]/40 bg-black/95 p-4 text-center text-[14px] font-bold uppercase text-white shadow-[0_0_30px_rgba(0,255,80,0.35)]">
