...
export default function ReviewsPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <div className="relative z-30 px-6 py-32">
    ...
    <section className="relative z-10 mx-auto mt-14 max-w-6xl rounded-3xl border border-white/15 bg-white/10 p-6 shadow-2xl backdrop-blur">
    ...
    >
        ...
        {[1, 2, 3, 4, 5].map((star) => (
            ...
            className={`relative z-40 cursor-pointer touch-manipulation ${star <= generalRating ? "text-yellow-400" : "text-white/30"}`}
            >
            ★
            </button>
        ))}
          ...
          <div className="mt-6 grid gap-5">
            {sortedServices.map((service) => (
              <button
                ...
                className="relative z-40 block w-full cursor-pointer touch-manipulation rounded-3xl border border-white/15 bg-white/10 p-6 text-left shadow-xl backdrop-blur transition hover:-translate-y-1 hover:border-[#69ff2f]"
              >
      ...
      {selectedServiceData && (
        <section ref={detailRef} className="mx-auto mt-10 max-w-6xl">
          ...
          <div className="rounded-3xl border border-[#69ff2f]/40 bg-white/10 p-6 shadow-2xl backdrop-blur">
            ...
            <div className="relative z-10 mt-8 rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur">
        ...
        >
            ...
            {[1, 2, 3, 4, 5].map((star) => (
                ...
                className={`relative z-40 cursor-pointer touch-manipulation ${
                  star <= serviceRating ? "text-yellow-400" : "text-white/30"
                }`}
                >
                ★
                </button>
